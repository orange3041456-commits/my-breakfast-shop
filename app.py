...
<body>
    ...
    <div class="setup">
        ...
        <div id="ts" style="display:none;margin-top:10px">桌號：{% for n in range(1,11) %}<button class="btn table-btn" onclick="setN('{{n}}',this)">{{n}}</button>{% endfor %}</div>{% endif %}
    </div>
    ...
    <div class="card">
        ...
        <div class="grid">
            ...
            {% if item.no_v %}<div class="opt" data-item="{{iid}}" onclick="tgl('{{iid}}','不加菜',0,this)" style="color:#e74c3c">✘不加菜</div>{% endif %}
