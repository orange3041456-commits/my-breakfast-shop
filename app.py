...
app = Flask(__name__)
app.secret_key = "morning_noodle_v63_final_update"
app.config.update(SESSION_COOKIE_HTTPONLY=True, SESSION_COOKIE_SAMESITE='Lax')

# --- 設定區 ---from flask import Flask, render_template_string, request, jsonify, session, redirect, url_for
import os, secrets, requests, datetime
import pytz
from collections import Counter
...
<body>
    <div class="sticky-nav no-print"><a href="/" class="nav-btn">🏠 返回點餐介面</a></div>
